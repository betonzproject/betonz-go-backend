...
func GetRewards(maxDay int) ([]DailyReward, error) {
	rewards := map[int]DailyReward{
		1:  {Day: 1, Reward: db.InventoryItemTypeBONUS, Amount: 2000},
		2:  {Day: 2, Reward: db.InventoryItemTypeTOKENA, Count: 3},
		3:  {Day: 3, Reward: db.InventoryItemTypeTOKENB, Count: 1},
		4:  {Day: 4, Reward: db.InventoryItemTypeBETONPOINT, Count: 2000},
		5:  {Day: 5, Reward: db.InventoryItemTypeREDPACK, Count: 1},
		6:  {Day: 6, Reward: db.InventoryItemTypeBONUS, Amount: 3000},
		7:  {Day: 7, Reward: db.InventoryItemTypeTOKENA, Count: 3},
		8:  {Day: 8, Reward: db.InventoryItemTypeTOKENB, Count: 1},
		9:  {Day: 9, Reward: db.InventoryItemTypeBETONPOINT, Count: 2000},
		10: {Day: 10, Reward: db.InventoryItemTypeREDPACK, Count: 1},
		11: {Day: 11, Reward: db.InventoryItemTypeBONUS, Amount: 3000},
		12: {Day: 12, Reward: db.InventoryItemTypeTOKENA, Count: 3},
		13: {Day: 13, Reward: db.InventoryItemTypeTOKENB, Count: 1},
		14: {Day: 14, Reward: db.InventoryItemTypeBETONPOINT, Count: 2000},
		15: {Day: 15, Reward: db.InventoryItemTypeREDPACK, Count: 1},
		16: {Day: 16, Reward: db.InventoryItemTypeBONUS, Amount: 4000},
		17: {Day: 17, Reward: db.InventoryItemTypeTOKENA, Count: 6},
		18: {Day: 18, Reward: db.InventoryItemTypeTOKENB, Count: 2},
		19: {Day: 19, Reward: db.InventoryItemTypeBETONPOINT, Count: 4000},
		20: {Day: 20, Reward: db.InventoryItemTypeROYALREDPACK, Count: 1},
		21: {Day: 21, Reward: db.InventoryItemTypeBONUS, Amount: 6000},
		22: {Day: 22, Reward: db.InventoryItemTypeTOKENA, Count: 6},
		23: {Day: 23, Reward: db.InventoryItemTypeTOKENB, Count: 2},
		24: {Day: 24, Reward: db.InventoryItemTypeBETONPOINT, Count: 4000},
		25: {Day: 25, Reward: db.InventoryItemTypeROYALREDPACK, Count: 1},
		26: {Day: 26, Reward: db.InventoryItemTypeRAFFLETICKET, Count: 1},
		27: {Day: 27, Reward: db.InventoryItemTypeTOKENA, Count: 6},
		28: {Day: 28, Reward: db.InventoryItemTypeTOKENB, Count: 2},
		29: {Day: 29, Reward: db.InventoryItemTypeBETONPOINT, Count: 4000},
